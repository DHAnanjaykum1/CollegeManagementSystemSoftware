 ...
 * @author cws
 */
public class ViewStudentDetails1 extends javax.swing.JFrame {

    /**
     * Creates new form ViewStudentDetails
     */
    public ViewStudentDetails1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Father Name", "D.O.B", "Address", "Phone", "Email ID", "Class X", "Class XII", "Adhar No", "Roll No", "Course", "Branch"
            }
        ) {
        ...
        jLabel2.setText("Search By Roll No");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStudentDetails1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStudentDetails1().setVisible(true);
            }
        });
    }
